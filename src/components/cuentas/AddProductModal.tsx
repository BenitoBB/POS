    ...
    <div className="modal-overlay z-[60]" onClick={onClose}>
      ...
      >
        ...
        <div className="relative">
          ...
          />
          <svg className="absolute right-3 top-3.5 text-[var(--text-muted)] pointer-events-none" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
